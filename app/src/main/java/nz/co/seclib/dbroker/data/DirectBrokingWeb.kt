...
class DirectBrokingWeb {
    ...
    private var mCurrentState = CurrentState("KMD",cookieJar,"","","","")
    ...
    fun findStockTradeInfo(sIn:String): StockCurrentTradeInfo? {
        ...
        val stockTradeInfo = StockCurrentTradeInfo()
    ...
    fun getLoginCookie(username:String,password:String): Boolean {
        ...
        fun run() {
            ...
            okClient.newCall(request).execute().use {
                ...
                if(mCurrentState.webPage.indexOf("Welcome") > 0) bAuthenticated = true
                it.body?.close()
            }
        }
